...
export const mainPageLinkElements: MainPageElements[] = [
    ...
    {
        title: 'Курс Diver NDL',
        subtitle: 'начальное обучение дайвингу',
        price: '435 $',
        description: 'Путь в мир дайвинга начинается с базового курса Diver NDL, который проходит 3-4 дня и включает в себя тренировку в закрытой воде и 4 погружений в открытой воде на глубину до 18 метров. В стоимость курса включены оборудование для дайвинга, учебные материалы и сертификат',
        image: '../images/main-page/kurs-diver-ndl.jpg',
        imageAlt: 'обучение дайвингу, курс Diver NDL, начальный курс дайвинга, обучение дайвингу в одессе',
        buttonText: 'Подробнее о курсе',
        buttonLink: '../diving-courses/ndl/kurs-diver-ndl.html'
    },
    {
        title: 'Технический дайвинг',
        subtitle: 'глубокий воздух, тримикс',
        price: 'от 150$',
        description: 'Глубокие погружения на воздухе или тримиксе в Черном море. Выезды на технический дайвинг на Красное и Средиземые моря',
    ...
    //     image: '../images/main-page/camping-ras-mohammed.jpg',
    ...
    //     image: '../images/main-page/diving-sharm-el-sheikh.jpg',
