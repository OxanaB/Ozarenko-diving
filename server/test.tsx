...
import { metaTechnicalDivingPage, metaSidemountPage, metaTechDivingRebreather, metaTechCoursesIantd, metaTechCoursesNdl } from '../technical-diving/meta-technical-diving';
...
const pages: any = {
    ...
    './technical-diving/techdiving-courses-iantd.html': ReactDom.renderToString(
        <Page meta={metaTechCoursesIantd} title={'Курсы технического дайвинга IANTD'}>
            <TechdivingCoursesIantd />
        </Page>
    ),
    './technical-diving/techdiving-courses-ndl.html': ReactDom.renderToString(
        <Page meta={metaTechCoursesNdl} title={'Курсы технического дайвинга NDL'}>
            <TechdivingCoursesNdl />
        </Page>
    ),
    './technical-diving/rebreather-diving.html': ReactDom.renderToString(
        <Page meta={metaTechDivingRebreather} title={'Ребризер дайвинг на Красном море, обучение. Megaladon & Inspiration'}>
            <Rebreather />
        </Page>
    )
};
