...
export class SpecialPage extends React.Component<SpecialPageProps> {
    render() {
        return <html>
            <head>
                ...
                <script src="https://www.google.com/recaptcha/api.js?onload=noRobot&render=explicit" async defer></script>
