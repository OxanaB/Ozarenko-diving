...
export class NorthRoutes extends React.Component {
    render() {
        return <div className="page-container">
            ...
            <img src="" title="Маршрут сафари &quot;Север классика&quot;" alt="зафрахтовать сафари, дайвинг сафари по северу красного моря, дайвинг сафари из шарм эль шейха, дайв сафари египет" />
            ...
            <img src="" title="Маршрут дайв-сафари &quot;Северные рэки (wreck diving)&quot;" alt="зафрахтовать сафари, серевные рэки красного моря, дайвинг сафари по северу красного моря, дайвинг сафари из шарм эль шейха, дайв сафари египет" />
            ...
            <img src="" title="Маршрут дайв-сафари &quot;Шарм -Дахаб, или Золотой путь&quot;" alt="зафрахтовать сафари, из шарма в дахаб морем, дайвинг сафари по северу красного моря, дайвинг сафари из шарм эль шейха, дайв сафари египет" />
            <p>Маршрут подходит для уже опытных дайверов, с уровнем не ниже Advanced open water diver.</p>
            <p>Примерный маршрут дайвинг сафари (будет зависеть от погодных условий и опытности дайверов):</p>
            <p>День 0: Прибытие в Шарм-эль-Шейх, заселение на яхту, ужин и ночевка в порту</p>
