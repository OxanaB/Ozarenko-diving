...
export class NorthRoutes extends React.Component {
    render() {
        return <div className="page-container">
            ...
            <h4>Мы рекомендуем иметь минимум 20 зарегистрированных погружений для маршрута «Север классика» и минимум 35 зарегистрированных погружений для маршрутов «Северные Рэки» и «Шарм-Дахаб».</h4>
            <h2>Север классика</h2>
            <img src="/images/liveaboard/north-wreck-and-reef.jpg" alt="Маршрут дайвинг сафари по северу красного моря &quot;Север классика&quot; из Шарм эль Шейха (Египет)" />
            ...
            <img src="/images/liveaboard/north-wreck-and-ras-mohammed.jpg" alt="Маршрут дайвинг сафари по северу красного моря &quot;Северные рэки (wreck diving)&quot; из Шарм эль Шейха (Египет)"   />
            ...
            <img src="/images/liveaboard/north-sharm-dahab.jpg" title="Маршрут дайвинг сафари по северу красного моря&quot;Шарм - Дахаб, или Золотой путь&quot; из Шарм эль Шейха (Египет)" />
            <p>Маршрут подходит для уже опытных дайверов, с уровнем не ниже Advanced open water diver.</p>
            <p>Примерный маршрут дайвинг сафари (будет зависеть от погодных условий и опытности дайверов):</p>
            <p>День 0: Прибытие в Шарм-эль-Шейх, заселение на яхту, ужин и ночевка в порту</p>
