...
export class IdcCourses extends React.Component {
    render() {
        return <div className="page-container">
            <h1>Профессиональные курсы инструкторов по дайвингу <a href="#IantdIdc">IANTD</a> и <a href="#NdlItc">NDL</a>. Курс-директор Виктор Озаренко</h1>
            ...
            <img src="" title="Курсы инструкторов по дайвингу IANTD от Виктора Озаренко" alt="инструкторские курсы, idc iantd, курсы инструкторов по дайвингу, инструкторские курсы IANTD, профессиональные курсы дайвинга, курс директор Виктор Озаренко, инструкторские курсы Одесса, обучение инструкторов по дайвингу Одесса в Одессе" />
            ...
            <p>Минимальный возраст 18 лет, минимум 100 погружений, исходный уровень Divemaster IANTD или эквивалент других систем имеющий квалификацию Basic Nitrox Diver.</p>
            <h3>Инструкторский курс Advanced EANx Instructor.</h3>
            <p>Минимальный возраст 18 лет, минимум 100 погружений, исходный уровень Divemaster IANTD, или Open water EANx Instructor IANTD, а также Divemaster или Open water Instructor других систем обучения имеющиe квалификацию Advanced Nitrox Diver или эквивалент.</p>
            <h3>Инструкторский курс Technical Instructor.</h3>
            <p>Минимальный возраст 21 год, минимум 250 погружений. Должен иметь квалификацию инструктора IANTD уровня Advanced Nitrox с подтверждённым статусом или эвивалент, иметь дайверскую квалификацию IANTD Technical Diver или эквивалент</p>
            <h3>Инструкторский курс Normoxic Trimix Instructor.</h3>
            <p>Минимальный возраст 21 год, минимум 250 погружений. Должен иметь квалификацию инструктора IANTD уровня Advanced Nitrox с подтверждённым статусом или эвивалент, иметь дайверскую квалификацию IANTD Trimix Diver или эквивалент.</p>
            <h3>Инструкторский курс Trimix Instructor.</h3>
            <p>Инструктор IANTD уровня Trimix представляет собой высшую степень совершенства в овладении мастерством погружений на смесях в продвинутом дайвинге. Минимальный возраст 21 год. Должен представить доказательства не менее 500 зарегистрированных погружений, 200 из которых совершались на глубины свыше 30 метров, и не менее 50 погружений на смесях Trimix. Должен иметь квалификацию инструктора IANTD уровня Normoxic Trimix или эквивалент с подтверждённым статусом инструктора не менее 1 года.</p>

            <h2 id="NdlItc">Инструкторские курсы по системе NDL</h2>
            <img src="" title="Курсы инструкторов по дайвингу NDL от Виктора Озаренко" alt="инструкторские курсы, itc ndl, курсы инструкторов по дайвингу, инструкторские курсы NDL, профессиональные курсы дайвинга, курс директор Виктор Озаренко, инструкторские курсы Одесса, обучение инструкторов по дайвингу Одесса в Одессе" />
            <h3>Инструкторский курс NDL (Instructor Training Course - ITC)</h3>
            ...
            <ul><li>Подготовка академических презентаций (подготовка и проведение лекций).</li>
                <li>Организация и проведение занятий в воде по всем основным любительским курсам NDL.</li>
                <li>Мастерское владение плавучестью.</li></ul>
