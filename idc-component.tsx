...
export class IdcCourses extends React.Component {
    render() {
        return <div className="page-container">
            <h1>Обучение инструкторов по дайвингу. Курс-директор Виктор Озаренко</h1>
            ...
            <h2>Инструкторские курсы по системе IANTD</h2>
            ...
            <h2>Инструкторские курсы по системе NDL</h2>
