...
export class TechdivingCoursesNdl extends React.Component {
        render() {
                return <div className="page-container">
                        ...
                        <p>Пожалуйста оставьте<a href="/contact-us.html"> заявку</a> на прохождение курсов технического дайвинга на сайте, либо сообщите о своем приезде по <a href="mailto:ozarenko.diving@gmail.com">электронной почте</a> , или другим удобным способом, заранее , для того, чтобы мы смогли сделать ваше обучение и подводные приключения максимально комфортными!</p>
                        <div className="tech-courses">
                                ...
                                <div>
                                        ...
                                        <p> Программа рассчитана на сертифицированных дайверов любого уровня подготовки (старше 14 лет). Занятие проводятся с комплектом снаряжения, в котором дайвер, совершает любительские погружения. В комплекте для подводного плавания заменяется только SCUBA (спарка с монифолдом, 2Х12 литров). </p>
